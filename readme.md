# X-ray Security Inspection Data Set】9 categories including knives scissors glass bottles pliers.

# Body

X-ray Security Inspection Data Set】9 classifications, including small knives, scissors, glass bottles, pliers, metal cups, umbrellas, lighters, pressure cookers, laptops. The data set consists of 4527 images. The dataset is distributed as 7:2:1. Among them, there are 3168 training images, 905 validation images, and 453 test images. All image samples are labeled in txt format under the YOLO model. This product is a virtual one, please understand. You can directly train with the code after obtaining it.
